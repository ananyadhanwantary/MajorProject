    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", justifyContent: "center", gap: "20px" }}>
          <button
            style={{
              backgroundColor: "#d98b4e", // Matching header/footer gradient
              color: "white",
              padding: "10px 20px",
              borderRadius: "8px",
              border: "none",
            ...
            onMouseOver={(e) => (e.target.style.backgroundColor = "#f6c667")}
            onMouseOut={(e) => (e.target.style.backgroundColor = "#d98b4e")}
            onClick={() => window.location.href = "/abstract"}
          >
            Go to Abstract
          </button>
          <button
            style={{
              backgroundColor: "#f6c667", // Lighter shade of the same gradient
              color: "white",
              padding: "10px 20px",
              borderRadius: "8px",
              border: "none",
            ...
            onMouseOver={(e) => (e.target.style.backgroundColor = "#d98b4e")}
            onMouseOut={(e) => (e.target.style.backgroundColor = "#f6c667")}
            onClick={() => navigate("/upload")}
          >
            Go to Upload Page
          </button>
