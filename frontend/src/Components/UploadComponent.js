  ...
  return (
    <div
      style={{
        fontFamily: "'Roboto', sans-serif",
        color: "#2c3e50",
        backgroundColor: "#eef2f7",  // Keeping the page background the same
        minHeight: "100vh",
        padding: "20px",
        boxSizing: "border-box",
      }}
    >
      ...
      <section
        style={{
          background: "linear-gradient(135deg, #f6c667, #d98b4e)",  // Gradient using the specified colors
          color: "white",
          padding: "40px 30px",
          borderRadius: "10px",
          marginBottom: "30px",
      ...
      >
        ...
        >
          ...
          <button
            style={{
              background: "#d98b4e",  // Matching gradient colors from HomeComponent
              color: "white",
              padding: "10px 20px",
              borderRadius: "8px",
              border: "none",
            ...
            onMouseOver={(e) => (e.target.style.background = "#f6c667")}  // Lighter gradient on hover
            onMouseOut={(e) => (e.target.style.background = "#d98b4e")}
            onClick={handleAnalyze}
          >
            Analyze Images
          </button>
